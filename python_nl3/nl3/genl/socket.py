...
class Socket(_Socket):
    ...
    @wrap(genl, errcode_check, c_int, c_nl_sock_p)
    def genl_connect(): pass

    @wrap(genl, errcode_check, c_int, c_nl_sock_p, c_int, c_int, c_int, c_int)
    def genl_send_simple(): pass

    @wrap(genl, errcode_check, c_int, c_nl_sock_p, c_char_p)
    def genl_ctrl_resolve():
        """int genl_ctrl_resolve(struct nl_sock *, const char *); """

    @wrap(genl, errcode_check, c_int, c_nl_sock_p, c_char_p, c_char_p)
